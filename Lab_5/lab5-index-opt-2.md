...
> Czas wykonania rozłożył się na RDI lookup i przeszukanie indeksu. K oszt tych operacji to po 50% kosztu całości zapytania. Sumaryczny czas nieznacznie się zwiększył! Większość czasu to operacje zagnieżdżonej pętli. Nie uzyskujemy optymalizacji dla tego zapytania.
...
> Wszystkie 3 zapytania to proste skany tabel. Jesteśmy w stanie z nich wywnioskować, że jest w tabeli 14 osób z imieniem którego szukamy, 2 z tym nazwiskiem, ale dokładnie jedna z takim imieniem i nazwiskiem.
...
> Dla zapytania 1 i 3 (o samo nazwisko i samo imię) nie użyto indeksu. Stało się tak zapewne przez to, że indeks został utworzony dla pary (imię, nazwisko). W poprzednim przykładzie z `'Osarumwense Agbonile'`, nazwisko to było jedynym wpisem w tabeli o takim imieniu, a także jedynym o takim nazwisku przez to SZBD mógł użyć indeksu. W bazie jest jednak więcej niż jedna osoba z nazwiskiem Price i więcej niż jedna z imieniem Angela. By je wyszukać system używa zwykłego skanu tabeli.
